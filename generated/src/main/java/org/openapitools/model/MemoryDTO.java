...
public class MemoryDTO {
   ...
   */
  public MemoryDTO(String id, String title, String description, Mood mood) {
    this.id = id;
    this.title = title;
  ...
  */
  ...
  public MemoryDTO title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public MemoryDTO description(String description) {
    this.description = description;
    return this;
  }
  ...
  */
  ...
  public MemoryDTO mood(Mood mood) {
    this.mood = mood;
    return this;
  }
  ...
  */
  ...
  public MemoryDTO tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public MemoryDTO addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  */
  ...
  public MemoryDTO images(List<@Valid Image> images) {
    this.images = images;
    return this;
  }

  public MemoryDTO addImagesItem(Image imagesItem) {
    if (this.images == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, memoryDTO.id) &&
        Objects.equals(this.title, memoryDTO.title) &&
        Objects.equals(this.description, memoryDTO.description) &&
        Objects.equals(this.mood, memoryDTO.mood) &&
        Objects.equals(this.tags, memoryDTO.tags) &&
        Objects.equals(this.images, memoryDTO.images);
  }
